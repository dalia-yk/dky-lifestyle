      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {services.map((service) => (
          <Link
            ...
            className={`group relative rounded-2xl overflow-hidden bg-gradient-to-br ${service.tone} border border-brand-champagne/20 hover:border-brand-champagne/50 transition-all p-6 h-56 flex flex-col justify-end`}
          >
